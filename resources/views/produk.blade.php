                ...
                <div class="p-4">
                    <div class="grid grid-cols-4 gap-6 mb-4">
                        <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow">
                            <img style="height: 75% rounded-lg" src="{{ asset('img/popular1.jpeg')}}" alt="product image" />

                             <div class="px-2 py-4">
                                <a href="#">
                                    <h5 class="text-base font-semibold tracking-tight text-gray-900">Troublemaker - Short Pants - Gumlock Black</h5>
                                </a>
                                <div class="flex items-center justify-between">
                                    <span class="text-base font-bold text-gray-900">
                                        <p class="text-xs text-left font-medium text-gray-500">Harga</p>Rp. 75.000</span>
                                        <a href="#" class=" bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg px-2 py-2">
                        ...
                        <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow">
                            <img style="height: 75% rounded-lg" src="{{ asset('img/popular2.jpeg')}}" alt="product image" />

                             <div class="px-2 py-4">
                                <a href="#">
                                    <h5 class="text-base font-semibold tracking-tight text-gray-900">Troublemaker - Outwear Jacket - Hurricane Black</h5>
                                </a>
                                <div class="flex items-center justify-between">
                                    <span class="text-base font-bold text-gray-900">
                                        <p class="text-xs text-left font-medium text-gray-500">Harga</p>Rp. 245.000</span>
                                        <a href="#" class=" bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg px-2 py-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="h-4 w-4">
                                                <path fill="#ffffff" d="M0 24C0 10.7 10.7 0 24 0H69.5c22 0 41.5 12.8 50.6 32h411c26.3 0 45.5 25 38.6 50.4l-41 152.3c-8.5 31.4-37 53.3-69.5 53.3H170.7l5.4 28.5c2.2 11.3 12.1 19.5 23.6 19.5H488c13.3 0 24 10.7 24 24s-10.7 24-24 24H199.7c-34.6 0-64.3-24.6-70.7-58.5L77.4 54.5c-.7-3.8-4-6.5-7.9-6.5H24C10.7 48 0 37.3 0 24zM128 464a48 48 0 1 1 96 0 48 48 0 1 1 -96 0zm336-48a48 48 0 1 1 0 96 48 48 0 1 1 0-96z"/>
                                            </svg>
                        ...
                        <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow">
                            <img style="height: 75% rounded-lg" src="{{ asset('img/popular3.jpeg')}}" alt="product image" />

                             <div class="px-2 py-4">
                                <a href="#">
                                    <h5 class="text-base font-semibold tracking-tight text-gray-900">Troublemaker - Short Pants - Swimshort Black</h5>
                                </a>
                                <div class="flex items-center justify-between">
                                    <span class="text-base font-bold text-gray-900">
                                        <p class="text-xs text-left font-medium text-gray-500">Harga</p>Rp. 65.000</span>
                                        <a href="#" class=" bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg px-2 py-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="h-4 w-4">
                                                <path fill="#ffffff" d="M0 24C0 10.7 10.7 0 24 0H69.5c22 0 41.5 12.8 50.6 32h411c26.3 0 45.5 25 38.6 50.4l-41 152.3c-8.5 31.4-37 53.3-69.5 53.3H170.7l5.4 28.5c2.2 11.3 12.1 19.5 23.6 19.5H488c13.3 0 24 10.7 24 24s-10.7 24-24 24H199.7c-34.6 0-64.3-24.6-70.7-58.5L77.4 54.5c-.7-3.8-4-6.5-7.9-6.5H24C10.7 48 0 37.3 0 24zM128 464a48 48 0 1 1 96 0 48 48 0 1 1 -96 0zm336-48a48 48 0 1 1 0 96 48 48 0 1 1 0-96z"/>
                                            </svg>
                        ...
                        <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow">
                            <img style="height: 75% rounded-lg" src="{{ asset('img/popular4.jpeg')}}" alt="product image" />

                             <div class="px-2 py-4">
                                <a href="#">
                                    <h5 class="text-base font-semibold tracking-tight text-gray-900">Troublemaker - Caps Baseball - Shadow Blackk</h5>
                                </a>
                                <div class="flex items-center justify-between">
                                    <span class="text-base font-bold text-gray-900">
                                        <p class="text-xs text-left font-medium text-gray-500">Harga</p>Rp. 75.000</span>
